    ...
    return (
      <div className={styles.projectsDiv}>
        ...
        <ProjectItem
          ...
          content={'JavaScript + React + Node.js + Express.js를 이용한 Front-end 개발 및 Java + MariaDB를 이용한 Back-end API 일부 작업'}
          url={'https://talken.io'}
        />
        <ProjectItem
          title={'Colligence Corp. Site'}
          duration={'2019.02 (Within 1 week)'}
          content={'개발 100%, JavaScript, React를 이용한 Front-end 개발'}
        ...
        />
        <ProjectItem
          title={'게임 Application, 『고양이 상자에는 마법이 담겨있나요?』'}
